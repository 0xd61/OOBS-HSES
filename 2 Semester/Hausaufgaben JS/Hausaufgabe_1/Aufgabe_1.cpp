...
int main()
{
	...
	cout << "Zeit: " << buffer;
	cout << " Dies ist ein Test: üäöÜÖÄß. Ok?" << endl << endl;
	...
	cout << "Locale ist: " << setlocale(LC_ALL, NULL) << endl << endl;
	strftime(buffer, 80, "%c", timeinfo);
	...
	/*
	LC_CTYPE = Maximale Länge in Bytes eines beliebigen Multibytezeichens im aktuellen Gebietsschema.
	*/
