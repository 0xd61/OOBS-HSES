...
public:
	D1(int C1_a = 0xD1C1A, int C2_a = 0xD1C2A,int C1_b = 0xD1C1B, int C2_b = 0xD1C2B): C1(C1_a, C1_b), C2(C2_a, C2_b) {}
	
	void print() 
	{
		cout << "D1::print() ..." << endl;
		string strArr[] =	{ "C1::a", "C2::a", "C1::b", "C2::b"};

		int * intPtrArr[] = { &(C1::a), &(C2::a),&(C1::b), &(C2::b) };
...
class D2 :public C1, public C2, public C3 
{
	public:
		...
		{ 
			cout << "D2::print() ..." << endl;
			string strArr[] = { "C1::a", "C2::a", "C3::a", "C1::b", "C2::b", "C3::b" };
			int * intPtrArr[] = { &(C1::a), &(C2::a), &(C3::a),  &(C1::b), &(C2::b), &(C3::b) };
